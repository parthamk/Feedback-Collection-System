...
const Contact = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-gradient-to-r from-cyan-200 to-red-400 ">
        {/* <div className="container mx-auto px-10 py-10"> */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-fit mx-12 md:mx-10 mt-5 mb-5 bg-gradient-to-r from-yellow-100 to-yellow-300 p-4 rounded-lg">
                ...
                <textarea name='message' id="message" placeholder='Your message' className=" p-1 mt-1 w-full outline-none border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-90 block"></textarea>
                    ...
                    <button className="text-white bg-gradient-to-r from-blue-400 to-red-600 p-2 rounded-md mt-5 font-bold ">Submit</button>
                </div>
